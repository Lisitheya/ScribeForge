...
const UNIVERSAL: FontDef[] = [
  { id: 'spectr', name: 'Spectral', family: "'Spectral', Georgia, 'Times New Roman', serif" },
  { id: 'aleg', name: 'Alegreya', family: "'Alegreya', Georgia, 'Times New Roman', serif" },
  { id: 'ptser', name: 'PT Serif', family: "'PT Serif', Georgia, 'Times New Roman', serif" },
  { id: 'yanone', name: 'Yanone Kaffeesatz', family: "'Yanone Kaffeesatz', 'Franklin Gothic Medium', 'Segoe UI', sans-serif" },
];

const F = {
  jb: { id: 'jb', name: 'JetBrains Mono', family: "'JetBrains Mono', 'Cascadia Mono', 'DejaVu Sans Mono', Consolas, monospace" },
  rubik: { id: 'rubik', name: 'Rubik Mono One', family: "'Rubik Mono One', 'Arial Black', Impact, sans-serif" },
  ptm: { id: 'ptm', name: 'PT Mono', family: "'PT Mono', 'DejaVu Sans Mono', Consolas, monospace" },
  courier: { id: 'courier', name: 'Courier Prime', family: "'Courier Prime', 'Courier New', Courier, monospace" },
  fira: { id: 'fira', name: 'Fira Mono', family: "'Fira Mono', 'DejaVu Sans Mono', Consolas, monospace" },
  ebg: { id: 'ebg', name: 'EB Garamond', family: "'EB Garamond', Garamond, Georgia, 'Times New Roman', serif" },
  corm: { id: 'corm', name: 'Cormorant', family: "'Cormorant Garamond', Garamond, Georgia, serif" },
  marck: { id: 'marck', name: 'Marck Script', family: "'Marck Script', 'Segoe Script', 'Brush Script MT', cursive" },
  caveat: { id: 'caveat', name: 'Caveat', family: "'Caveat', 'Segoe Script', 'Comic Sans MS', cursive" },
  playf: { id: 'playf', name: 'Playfair Display', family: "'Playfair Display', Georgia, 'Times New Roman', serif" },
  liter: { id: 'liter', name: 'Literata', family: "'Literata', Georgia, 'Times New Roman', serif" },
  oldstd: { id: 'oldstd', name: 'Old Standard TT', family: "'Old Standard TT', 'Times New Roman', Times, serif" },
  comfort: { id: 'comfort', name: 'Comfortaa', family: "'Comfortaa', 'Trebuchet MS', 'Segoe UI', sans-serif" },
  neucha: { id: 'neucha', name: 'Neucha', family: "'Neucha', 'Comic Sans MS', cursive" },
  badscript: { id: 'badscript', name: 'Bad Script', family: "'Bad Script', 'Segoe Script', cursive" },
};
